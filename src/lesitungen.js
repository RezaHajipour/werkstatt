...
// import services from "./images/auto-b2.png";
...
export default function NestedGrid() {
    ...
    return (
      <React.Fragment>
         <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={motor} />
            </Card>
        </Grid>
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={getriebe} />
            </Card>
        </Grid>
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={lenkrader} />
            </Card>
        </Grid>
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={ol} />
            </Card>
        </Grid>
    ...
    return (
      <React.Fragment>
        ...
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={stossdampfer} />
            </Card>
        </Grid>
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={zundung} />
            </Card>
        </Grid>
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={ausspuff} />
            </Card>
        </Grid>
    ...
    return (
      <React.Fragment>
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={batterie} />
            </Card>
        </Grid>
        <Grid item xs={2}>
            <Card>
            <CardMedia
              className={classes.media} image={bremse} />
            </Card>
        </Grid>
      </React.Fragment>
    );
  ...
  Leistungentut amut egypt
      ...
      >
        ...
        <Grid container item xs={12} spacing={1} justify="space-evenly" style={{ margin: 10 }}>
          <FormRow1 />
        </Grid>
        <Grid container item xs={12} spacing={1} justify="space-evenly" style={{ margin: 10 }}>
          <FormRow2 />
